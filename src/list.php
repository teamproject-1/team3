                ...
                <div class="list_box_right_detail scrollable">
                    <?php foreach($result as $item) { ?>
                        <div class="list_box_right_detail_box">
                            <a class="list_box_right_atag" href="detail.php?year=<?php echo $year ?>&month=<?php echo $month ?>&day=<?php echo $day ?>&td_id=<?php echo $item["td_id"] ?>"><span><?php echo $item["content"] ?></span></a>
